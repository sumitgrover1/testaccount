...
export default function ContactPage() {
  return (
    <div className="mx-auto max-w-5xl px-6 py-20">
      <p className="text-sm font-medium uppercase tracking-[0.2em] text-brand-600">Contact</p>
      ...
      <div className="mt-8 flex flex-wrap gap-4">
        ...
        <a
          ...
          className="rounded-full border border-brand-300 px-6 py-3 text-sm font-medium text-brand-700 transition hover:bg-brand-50"
        >
      ...
      <div className="mt-12 grid gap-12 md:grid-cols-2">
        ...
        <div className="space-y-6">
          <div>
            <h2 className="font-serif text-lg text-brand-700">Visit</h2>
            <a
          ...
          <div>
            <h2 className="font-serif text-lg text-brand-700">Call or Message</h2>
            <a href={`tel:${siteConfig.phone}`} className="mt-1 block text-sm text-charcoal-700 hover:text-brand-600">
          ...
          <div>
            <h2 className="font-serif text-lg text-brand-700">Hours</h2>
